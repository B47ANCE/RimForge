...
Assert-FileContains '.gitignore' '(?m)^Output/$' '.gitignore must ignore legacy Output runtime data.'
Assert-FileContains '.gitignore' '(?m)^Logs/$' '.gitignore must ignore legacy Logs runtime data.'
Assert-FileContains '.gitignore' '(?m)^Cache/$' '.gitignore must ignore legacy Cache runtime data.'
Assert-FileContains '.gitignore' '(?m)^Temp/$' '.gitignore must ignore legacy Temp runtime data.'
Assert-FileContains '.gitignore' '(?m)^Exports/$' '.gitignore must ignore legacy Exports runtime data.'
